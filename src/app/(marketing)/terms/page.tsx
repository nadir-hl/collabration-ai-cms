        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <article className="flex-1 space-y-10 text-[--color-text] min-w-0">
            ...
            <section id="1-acceptance-of-terms">
              <h2 className="text-lg font-bold text-[--color-text] mb-3">1. Acceptance of terms</h2>
            ...
            <section id="2-use-of-the-services">
              <h2 className="text-lg font-bold text-[--color-text] mb-3">2. Use of the services</h2>
              ...
              <ul className="list-disc pl-6 space-y-2 text-[--color-text-muted] leading-relaxed">
                ...
                <li>Attempt to gain unauthorised access to any part of the Services, its related systems, or networks</li>
                <li>Transmit any material that is unlawful, harmful, defamatory, or otherwise objectionable</li>
                <li>Use automated means (bots, scrapers, crawlers) to access or collect data from the Services without our prior written permission</li>
                <li>Interfere with or disrupt the integrity or performance of the Services</li>
                <li>Reproduce, duplicate, copy, sell, or exploit any portion of the Services without express written permission from us</li>
              </ul>
            </section>

            <section id="3-accounts">
              <h2 className="text-lg font-bold text-[--color-text] mb-3">3. Accounts</h2>
              <p className="text-[--color-text-muted] leading-relaxed">
            ...
            <section id="4-intellectual-property">
              <h2 className="text-lg font-bold text-[--color-text] mb-3">4. Intellectual property</h2>
              <p className="text-[--color-text-muted] leading-relaxed">
            ...
            <section id="5-user-content">
              <h2 className="text-lg font-bold text-[--color-text] mb-3">5. User content</h2>
              <p className="text-[--color-text-muted] leading-relaxed">
            ...
            <section id="6-disclaimer-of-warranties">
              <h2 className="text-lg font-bold text-[--color-text] mb-3">6. Disclaimer of warranties</h2>
              <p className="text-[--color-text-muted] leading-relaxed">
            ...
            <section id="7-limitation-of-liability">
              <h2 className="text-lg font-bold text-[--color-text] mb-3">7. Limitation of liability</h2>
              <p className="text-[--color-text-muted] leading-relaxed">
            ...
            <section id="8-third-party-services">
              <h2 className="text-lg font-bold text-[--color-text] mb-3">8. Third-party services</h2>
              <p className="text-[--color-text-muted] leading-relaxed">
            ...
            <section id="9-termination">
              <h2 className="text-lg font-bold text-[--color-text] mb-3">9. Termination</h2>
              <p className="text-[--color-text-muted] leading-relaxed">
            ...
            <section id="10-governing-law">
              <h2 className="text-lg font-bold text-[--color-text] mb-3">10. Governing law</h2>
              <p className="text-[--color-text-muted] leading-relaxed">
            ...
            <section id="11-changes-to-these-terms">
              <h2 className="text-lg font-bold text-[--color-text] mb-3">11. Changes to these terms</h2>
              <p className="text-[--color-text-muted] leading-relaxed">
            ...
            <section id="12-contact-us">
              <h2 className="text-lg font-bold text-[--color-text] mb-3">12. Contact us</h2>
              <p className="text-[--color-text-muted] leading-relaxed">
            ...
            <div className="pt-4 border-t border-[--color-border]">
              <Link href="/privacy" className="text-sm text-[--color-brand-600] hover:underline">
                Read our Privacy Policy <ArrowRight size={14} className="inline ml-0.5" />
              </Link>
            </div>
          </article>
        </div>
