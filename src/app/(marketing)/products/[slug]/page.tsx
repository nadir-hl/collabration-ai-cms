    ...
    <>
      ...
      <section className="border-b border-[--color-border]">
        <div className="container py-16 md:py-20">
          <p className="text-sm font-semibold uppercase tracking-widest text-[--color-brand-500] mb-3">Product</p>
      ...
      {product.howItWorksWithOthers && (
        <section className="border-b border-[--color-border] bg-[--color-bg-subtle]">
          <div className="container py-12 max-w-3xl">
            <h2 className="text-lg font-semibold text-[--color-brand-900] mb-4">
      ...
      {product.proof && (
        <section className="border-b border-[--color-border]">
          <div className="container py-12 max-w-3xl">
            <h2 className="text-lg font-semibold text-[--color-brand-900] mb-4">Why it works</h2>
